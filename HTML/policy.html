    ...
    <div class="container-fluid">
      ...
      <div class="row py-4">
        ...
        <div class="col-12 col-md-6 col-lg-7 p-5 py-md-1">
          <h3>Politiche di Reso e Rimborso</h3> 
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus eligendi, nisi deserunt veritatis, molestiae labore quo officiis nulla vitae quam nam cupiditate corporis eveniet. Nam nemo eaque aliquid ex eveniet!</p>
        </div>
        <div class="col-md-1"></div>
      </div>
        <div class="row">
