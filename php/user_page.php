      ...
      <div class="row py-4">
        ...
        <div class="col-12 col-md-6 col-lg-7 p-5 py-md-1">
          ...
          <div class="container px-0 py-3">
            ...
            <div class="input-group mb-3">
              <input type="text" class="form-control" placeholder="Cognome" aria-label="Recipient's username" aria-describedby="basic-addon2">
            ...
            <div class="input-group mb-3">
              <input type="text" class="form-control" placeholder="Indirizzo di spedizione" aria-label="Recipient's username" aria-describedby="basic-addon2">
