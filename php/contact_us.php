      ...
      <div class="row py-4">
        ...
        <div class="col-12 col-md-6 col-lg-7 p-5 py-md-1">
          ...
          <div class="input-group my-3">
            <input type="text" class="form-control" placeholder="Oggetto" aria-label="Username" aria-describedby="basic-addon1">
          </div>
          <div class="input-group h-50">
            <textarea class="form-control" placeholder="Testo della domanda" aria-label="With textarea"></textarea>
          </div>
        </div>
        <div class="col-md-1"></div>
      </div>
