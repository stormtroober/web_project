<div class="row">
  <div class="col-12 p-0">
    <header class="py-3 text-white bg-dark">
      <h1 class="text-monospace text-center"><a class="text-decoration-none text-white" href="index.php">Guitar
          Benter</a></h1>
    </header>
  </div>
</div>
<div class="row">
  <nav class="navbar navbar-expand-lg navbar-light bg-light-gray">
    <div class="container-fluid text-center">
      <a class="navbar-brand" href="index.php"><img src="../resources/icons/guitar.png" height="60" width="60"
          alt="guitar_home_icon"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item px-2">
            <div class="container-fluid text-center px-0">
              <a class="nav-link" href="./login.php"><img src="../resources/icons/profilo.png" height="30" width="30"
                  alt="profile_icon"></a>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link" href="notifications.php"><img src="../resources/icons/notifica.png" height="30"
                width="30" alt="notifications_icon">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="dropdown-item text-center">
                <a class="btn text-decoration-none text-primary w-100" href="./clear_notifications.php">Clear All</a>
              </li>
              <?php
              } else { 
               echo "<li class=\"dropdown-item\">There are no notifications</li>"; 
              } ?>
            </ul>
          </li>
          <li class="nav-item text-center px-2">
            <a class="nav-link" href="cart.php"><img src="../resources/icons/carrello.png" height="30" width="30"
                alt="cart_icon"></a>
            <a class="nav-link active xs-text" aria-current="page" href="cart.php">Shopping Cart</a>
          </li>
          <li class="nav-item text-center px-2">
            <a class="nav-link" href="wishlist.php"><img src="../resources/icons/desideri.png" height="30" width="30"
                alt="wishlist_icon"></a>
            <a class="nav-link active xs-text" aria-current="page" href="wishlist.php">WishList</a>
          </li>
        </ul>
        <div id="order" class="dropdown">
          <button id="ddbt" class="btn btn-secondary dropdown-toggle m-2" type="button" data-bs-toggle="dropdown"
        ...
        <form action="./category_page.php?type=<?php if(isset($idcategoria)) {
          ...
          <button class="btn" type="submit"><img src="../resources/icons/lente.png" height="30" width="30"
