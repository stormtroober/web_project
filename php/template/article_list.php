        ...
        <div class="row m-2 m-md-5" style="border-radius: 25px; background-color: #e8e8e8">
            ...
            <div class="col-12 col-md-7 col-lg-5 pt-3">
                <a class="text-decoration-none text-dark h3"
                    href="article_page.php?add=false&id=<?php echo "categoria"; ?>"
                    ...
                    <div class="d-flex flex-column">
                        <div class="d-flex">
                            <img src="../resources/icons/tick.png" height="35px" width="25px" class="me-2"
                                alt="tick verify">
                            <span
                                class="fs-5 fs-xl-3"><?php echo "ciauz"; ?></span>
                        </div>
                        <div class="d-flex">
                            <img src="../resources/icons/tick.png" height="35px" width="25px" class="me-2"
                                alt="tick verify">
                            <span class="text_list"><?php echo "ciauz"; ?></span>
                        </div>
                        <div class="d-flex">
                            <img src="../resources/icons/tick.png" height="35px" width="25px" class="me-2"
                                alt="tick verify">
                        ...
                        <div class="d-flex mt-4">
                            <span id="available" class="text_list"><?php echo "ciauz"; ?></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-12 col-lg-3 col-xl-4 col-xxl-5 text-center px-4 py-3 pt-0">
                ...
                <span class="fs-3 fs-xl-2"><?php echo "$"; ?></span>
            </div>
