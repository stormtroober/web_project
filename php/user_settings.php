      ...
      <div class="row py-4">
        ...
        <div class="col-12 col-md-6 col-lg-7 p-5 py-md-1">
          ...
          <div class="input-group my-3">
            <label class="input-group-text" for="inputGroupSelect01">Notifiche</label>
            <select class="form-select" id="inputGroupSelect01">
              <option selected>Seleziona..</option>
              <option value="1">Mostra sempre</option>
              <option value="2">Mostra settimanalmente</option>
              <option value="3">Non mostrare</option>
            </select>
          </div>
          <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01">Coockies</label>
            <select class="form-select" id="inputGroupSelect01">
              <option selected>Seleziona..</option>
              <option value="1">Usa cookies profilazione e di utilizzo</option>
              <option value="2">Usa solo cookies di utilizzo</option>
              <option value="3">Non salvare cookies</option>
            </select>
          </div>
          <button class="btn btn-dark float-end">Elimina account</button>
        </div>
      </div>
      <div class="col-md-1"></div>
      </div>
